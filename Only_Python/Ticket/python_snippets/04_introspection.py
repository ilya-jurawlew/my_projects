...
# путь к интерпретатору Python_Django_Flask
print(sys.executable)

# какой операционной системе мы работаем
print(sys.platform)

# Текущая версия Python_Django_Flask
print(sys.version)
...
# путь поиска модуля, список каталогов, в которых Python_Django_Flask будет искать модули во время импорта
print(sys.path)
