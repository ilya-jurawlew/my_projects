...
class Bot:
    ...
    def __init__(self, group_id, my_token):
        ...
        :param my_token: секретный токен из группы vk
        """
        self.group_id = group_id
        self.token = my_token
        self.vk = vk_api.VkApi(token=my_token)
    ...
    def send_image(self, image, user_id):
        ...
        upload_image = requests.post(url=upload_url, files={'photo': ('image.png', image, 'image/png')}).json()
        image_data = self.api.photos.saveMessagesPhoto(**upload_image)
