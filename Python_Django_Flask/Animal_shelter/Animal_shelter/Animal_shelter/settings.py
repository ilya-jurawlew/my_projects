...
SECRET_KEY = 'django-insecure-98yovy50%bqtzopl$-eguilz-209%%*#v$v+qifw2f-9wp4@#k'
...
SIMPLE_JWT = {
    ...
    'USER_AUTHENTICATION_RULE': 'rest_framework_simplejwt.app_users.default_user_authentication_rule',
